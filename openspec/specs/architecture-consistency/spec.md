...
Ensures active project documentation, setup assets, package metadata, and tests describe and validate the currently supported WebSocket + HTTP architecture rather than removed transports.
