...
Enable flexible CLI configuration for ai-classify tool, supporting custom config file paths, pure parameter mode, and customization of Ollama-related settings.
...
#### Scenario: 通过参数指定所有配置
- **WHEN** 用户运行 `ai-classify start -i ./input -o ./output --ollama-endpoint http://localhost:11434`
