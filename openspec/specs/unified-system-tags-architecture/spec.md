# Unified System Tags Architecture

## Purpose

Unify system tags architecture by storing system tags in the tags field with "system:" prefix, simplifying query logic and removing special cases.
